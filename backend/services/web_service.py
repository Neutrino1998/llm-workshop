...
class WebService:
    ...
    async def fetch(self, url: str, max_length: int = 1000000) -> str:
        """
    ...
    async def _fetch_jina(self, url: str, max_length: int = 1000000) -> str:
    ...
    async def _fetch_simple(self, url: str, max_length: int = 1000000) -> str:
        """简易网页抓取（纯文本提取），作为降级方案。"""
        headers = {
